...
def ctCreateText(tag, message="", color=(255, 255, 255, 255), position=(0, 0), size=None, rotation=0.0, name=None,
...
def ctBindFunctions(start=None, update=None, key_pressed=None, key_released=None, key_held=None, mouse_moved=None,
                    mouse_pressed=None, mouse_released=None, ray_cast=None, ray_cast_entered=None, ray_cast_exited=None,
                    collision=None):
